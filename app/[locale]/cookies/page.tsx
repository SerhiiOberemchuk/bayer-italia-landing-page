...
export async function generateMetadata({
  ...
  return {
    title: locale === "uk" ? "Політика cookies" : "Cookie Policy",
    description:
      locale === "uk"
        ? "Політика використання cookies на сайті Buyer Italia - інформація про файли cookie та їх використання."
        : "Cookie usage policy on the Buyer Italia website - information about cookies and their use.",
  }
}
