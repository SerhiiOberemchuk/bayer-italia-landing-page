...
const faqs = [
  ...
  },
  {
    ...
    answer: "Доставка в Україну (Нова пошта) — від 150 грн залежно від ваги. Доставка в Європу — від 10€. Точну вартість розраховуємо індивідуально для кожного замовлення."
  },
  {
    question: "Як відбувається оплата?",
    answer: "Ми працюємо за передоплатою 100%. Приймаємо оплату на картку, PayPal або криптовалюту. Після оплати закуповуємо товар та надсилаємо фотозвіт."
  },
  {
  ...
  },
  {
    ...
    answer: "Основний фокус — ZARA, Massimo Dutti, Mango, COS та інші популярні бренди. Також можемо закупити товари з інших італійських магазинів за запитом."
  }
]
