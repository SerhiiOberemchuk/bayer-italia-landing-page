      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 grid gap-4 grid-cols-2 md:grid-cols-3">
          {dict.items.map((category, index) => {
            ...
            return (
              <Card key={index} className="group border bg-card hover:shadow-lg transition-all duration-300 rounded-2xl cursor-pointer hover:border-italy-green/30">
                <CardContent className="p-6 text-center">
                  <div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-xl bg-secondary group-hover:bg-italy-green/10 transition-colors">
                    <Icon className="size-6 text-muted-foreground group-hover:text-italy-green transition-colors" />
                  </div>
