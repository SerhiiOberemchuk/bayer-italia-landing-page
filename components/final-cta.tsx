      ...
      <div className="mx-auto max-w-4xl">
        <AnimateIn variant="scale" duration={700}>
          <div className="relative overflow-hidden rounded-3xl bg-foreground p-8 md:p-12 text-center">
            {/* Decorative elements */}
            <div className="absolute top-0 left-0 w-32 h-32 bg-italy-green/20 rounded-full blur-3xl animate-gentle-pulse" />
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-italy-red/20 rounded-full blur-3xl animate-gentle-pulse" style={{ animationDelay: "1.5s" }} />
            ...
            <div className="relative">
              ...
              <AnimateIn variant="fade-up" delay={500}>
                <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Button 
                    size="lg" 
                    className="w-full sm:w-auto gap-2 bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-xl px-8 h-12 transition-transform hover:scale-[1.03] active:scale-[0.97]"
                    asChild
                  >
